...
import com.phonebook.utiles.ContactData;
import com.phonebook.utiles.DataProviders;
import com.phonebook.utiles.UserData;
...
public class AddNewContactTests extends TestBase{
    ...
    public void precondition(){
        ...
        app.getUser().fillLoginRegistrationForm(new User().setEmail(UserData.EMAIL)
